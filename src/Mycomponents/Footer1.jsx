            ...
            >
                ...
                <div class="container-fluid p-4 pb-0  footer-flex-container">
                        ...
                        <div class="mb-4 mb-md-0 footer-flex-item">
                            <h4 class="footer-heading mb-4">PUSHP MASALE</h4>
                            <hr className='my-4'  />
                        ...
                        <div class="footer-flex-item quick-link">
                ...
                <div style={{ display: 'flex' }} className="foot1 row">
                    ...
                    <div className="col-lg-1 col-xl-1 col-sm-2 col-3">
                        ...
                        <div className='footbox'  data-aos="fade-down" onClick={scrollTotop}><i class="fa fa-chevron-up"  aria-hidden="true" ></i>
                        </div>
                    </div>
                </div>
            </footer >

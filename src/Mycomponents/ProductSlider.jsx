            ...
            <>
                <div class='container-fluid' my-3 >
                    <div className="row title" style={{ marginBottom: "20px" }} >
                        <div class="col-sm-12 h3 text-center" style={{ fontFamily: 'sans-serif' }}>
                ...
                <div class='container-fluid' >
                     <OwlCarousel  margin={30} autoplay={true} autoplayTimeout={1000} lazyLoad={true} loop={true} className="owl-theme"  {...options} >

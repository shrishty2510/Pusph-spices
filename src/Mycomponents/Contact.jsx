  ...
  return (
    ...
    <section className="contact" style={{marginTop:'100px',}}>
       ...
       <div style={{backgroundColor:'#fff',}}>
                ...
                <div class="container">
                <div class="row">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14719.230492241071!2d75.900585791333!3d22.735390700975525!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3962e2b039622859%3A0xdd0df8d9fe32ec13!2sKhajrana%2C%20Indore%2C%20Madhya%20Pradesh!5e0!3m2!1sen!2sin!4v1649608669666!5m2!1sen!2sin" width="100%" height="350" style={{border:'0',}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" title="map"></iframe>
                </div>
                </div>
        </div>
...
//     YOUR MOBILE NO. : ${this.state.mobile}
//     YOUR MESSAGE : ${this.state.message}`);
//     event.preventdefault();
//     // let arr = [];
//     // arr.push((JSON.stringify(this.state)));
//     // console.log(arr);
...
//                         <div class="col-lg-6">
//                         <div class="card-shadow">
//                             <img src="https://www.wrappixel.com/demos/ui-kit/wrapkit/assets/images/contact/2.jpg" class="img-fluid" alt="mainpic" />
//                         </div>
//                         </div>
//                         <div class="col-lg-6">
//                         <div class="contact-box ml-3" >
//                             <h1 class="font-weight-bold mt-2"> Quick Contact</h1>
//                             <form  class="mt-4" action="https://formsubmit.co/jain.shrishty1818@gmail.com" method="POST" onSubmit={this.handlesubmit}>
//                             <div class="row">
//                                 <div class="col-lg-12">
//                                 <div class="form-group my-3">
//                                     <input class="form-control" type="text" placeholder="Your Name" name='yourname' value={this.state.yourname} />
//                                 </div>
//                                 </div>
//                                 <div class="col-lg-12">
//                                 <div class="form-group my-3">
//                                     <input class="form-control" type="email" placeholder="Your Email Address"  name='email' value={this.state.email}   />
//                                 </div>
//                                 </div>
//                                 <div class="col-lg-12">
//                                 <div class="form-group my-3">
//                                     <input class="form-control" type="number" placeholder="Mobile No."  name='mobile' value={this.state.mobile}  />
//                                 </div>
//                                 </div>
//                                 <div class="col-lg-12">
//                                 <div class="form-group my-3">
//                                     <textarea class="form-control" rows="3" placeholder="Message" value={this.state.message}  name='message'   ></textarea>
//                                 </div>
//                                 </div>
//                                 <div class="col-lg-12">
//                                 <button type="submit" class="btn btn-danger-gradiant mt-3 text-white border-0 px-3 py-2"><span> SUBMIT</span></button>
